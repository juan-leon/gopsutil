...
import (
	...
	cpu "github.com/juan-leon/gopsutil/cpu"
	"github.com/juan-leon/gopsutil/internal/common"
	mem "github.com/juan-leon/gopsutil/mem"
	net "github.com/juan-leon/gopsutil/net"
...
func (p *Process) ForegroundWithContext(ctx context.Context) (bool, error) {
	// see https://github.com/juan-leon/gopsutil/issues/596#issuecomment-432707831 for implementation details
	pid := p.Pid
